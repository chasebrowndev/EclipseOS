...
9c and 9d have landed, 9e is partial, and 9f's harness exists with no subjects
to point it at until Phase 2.
...
actually taken, COMP-14 budgets), milestone 6's gate (suspend/resume, lid), 9c's CI
run, the rest of 9e, and the benchmark subjects 9f is waiting on.
...
9's bar gate, what COMP-16 v0.2's Phase 1 additions still owe (9c's CI
run, the rest of 9e, and 9f's benchmark subjects, which cannot exist before
the milestones that create them), and the whole of Phase 2 (milestones 10–25), whose
