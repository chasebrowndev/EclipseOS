...
|---|---|---|
| `wlcs` headless conformance | COMP-15 §1 | harness (`crates/wlcs-abyss`) and the blocking `conformance` job in `gate.yml` exist; the suite has not yet been run to green |
