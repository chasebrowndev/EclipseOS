...
| `bar.widgets.now-playing.art` | bool | `#true` | live | Show album art in the Now Playing widget. Only art the player keeps on this machine is shown; nothing is downloaded. |
