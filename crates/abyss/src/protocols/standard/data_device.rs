...
impl SelectionHandler for AbyssState {
...
impl DataDeviceHandler for AbyssState {
    fn data_device_state(&self) -> &DataDeviceState {
        &self.data_device_state
    }
}

impl ClientDndGrabHandler for AbyssState {
...
impl ServerDndGrabHandler for AbyssState {
    fn send(&mut self, _mime_type: String, _fd: OwnedFd, _seat: Seat<Self>) {
        // No compositor-originated drags yet (trusted UI, COMP-10).
    }
}

delegate_data_device!(AbyssState);
