...
impl OutputPowerState {
    pub fn new(display: &DisplayHandle) -> Self {
        let global = display.create_global::<HeliosState, ZwlrOutputPowerManagerV1, _>(VERSION, ());
        Self {
            global,
            instances: Vec::new(),
        }
...
pub fn broadcast(state: &mut HeliosState, id: u64, on: bool) {
...
impl GlobalDispatch<ZwlrOutputPowerManagerV1, ()> for HeliosState {
    fn bind(
        _state: &mut Self,
...
impl Dispatch<ZwlrOutputPowerManagerV1, ()> for HeliosState {
    fn request(
        state: &mut Self,
        _client: &Client,
...
impl Dispatch<ZwlrOutputPowerV1, OutputPowerData> for HeliosState {
    fn request(
        state: &mut Self,
        _client: &Client,
