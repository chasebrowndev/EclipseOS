...
pub fn set_all_power(state: &mut HeliosState, on: bool) {
...
pub fn set_enabled(state: &mut HeliosState, id: u64, enabled: bool) -> bool {
...
fn rehome(state: &mut HeliosState, id: u64) {
...
pub fn internal_output(state: &HeliosState) -> Option<u64> {
    state
        .outputs
        .iter()
        .find(|e| {
...
pub fn lid_switch(state: &mut HeliosState, closed: bool) {
